...
// 	protoc        v3.14.0
// source: greet_s6_pri/greetpb/greet.proto
...
func (x *PrimeNumberDecomposition) Reset() {
	*x = PrimeNumberDecomposition{}
	if protoimpl.UnsafeEnabled {
		mi := &file_greet_s6_pri_greetpb_greet_proto_msgTypes[0]
...
func (*PrimeNumberDecomposition) Descriptor() ([]byte, []int) {
	return file_greet_s6_pri_greetpb_greet_proto_rawDescGZIP(), []int{0}
}
...
func (x *PrimeNumberRequest) Reset() {
	*x = PrimeNumberRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_greet_s6_pri_greetpb_greet_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*PrimeNumberRequest) Descriptor() ([]byte, []int) {
	return file_greet_s6_pri_greetpb_greet_proto_rawDescGZIP(), []int{1}
}
...
func (x *PrimeNumberResponse) Reset() {
	*x = PrimeNumberResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_greet_s6_pri_greetpb_greet_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*PrimeNumberResponse) Descriptor() ([]byte, []int) {
	return file_greet_s6_pri_greetpb_greet_proto_rawDescGZIP(), []int{2}
}
...
var File_greet_s6_pri_greetpb_greet_proto protoreflect.FileDescriptor

var file_greet_s6_pri_greetpb_greet_proto_rawDesc = []byte{
	0x0a, 0x20, 0x67, 0x72, 0x65, 0x65, 0x74, 0x5f, 0x73, 0x36, 0x5f, 0x70, 0x72, 0x69, 0x2f, 0x67,
	0x72, 0x65, 0x65, 0x74, 0x70, 0x62, 0x2f, 0x67, 0x72, 0x65, 0x65, 0x74, 0x2e, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x12, 0x0c, 0x67, 0x72, 0x65, 0x65, 0x74, 0x5f, 0x73, 0x36, 0x5f, 0x70, 0x72, 0x69,
	...
	0x36, 0x5f, 0x70, 0x72, 0x69, 0x2e, 0x50, 0x72, 0x69, 0x6d, 0x65, 0x4e, 0x75, 0x6d, 0x62, 0x65,
	...
	,
}

var (
	file_greet_s6_pri_greetpb_greet_proto_rawDescOnce sync.Once
	file_greet_s6_pri_greetpb_greet_proto_rawDescData = file_greet_s6_pri_greetpb_greet_proto_rawDesc
)

func file_greet_s6_pri_greetpb_greet_proto_rawDescGZIP() []byte {
	file_greet_s6_pri_greetpb_greet_proto_rawDescOnce.Do(func() {
		file_greet_s6_pri_greetpb_greet_proto_rawDescData = protoimpl.X.CompressGZIP(file_greet_s6_pri_greetpb_greet_proto_rawDescData)
	})
	return file_greet_s6_pri_greetpb_greet_proto_rawDescData
}

var file_greet_s6_pri_greetpb_greet_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_greet_s6_pri_greetpb_greet_proto_goTypes = []interface{}{
	(*PrimeNumberDecomposition)(nil), // 0: greet_s6_pri.PrimeNumberDecomposition
	(*PrimeNumberRequest)(nil),       // 1: greet_s6_pri.PrimeNumberRequest
	(*PrimeNumberResponse)(nil),      // 2: greet_s6_pri.PrimeNumberResponse
}
var file_greet_s6_pri_greetpb_greet_proto_depIdxs = []int32{
	0, // 0: greet_s6_pri.PrimeNumberRequest.primeNumberDecomposition:type_name -> greet_s6_pri.PrimeNumberDecomposition
	1, // 1: greet_s6_pri.CalculatorService.PrimeManyTimes:input_type -> greet_s6_pri.PrimeNumberRequest
	2, // 2: greet_s6_pri.CalculatorService.PrimeManyTimes:output_type -> greet_s6_pri.PrimeNumberResponse
...
func init() { file_greet_s6_pri_greetpb_greet_proto_init() }
func file_greet_s6_pri_greetpb_greet_proto_init() {
	if File_greet_s6_pri_greetpb_greet_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_greet_s6_pri_greetpb_greet_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_greet_s6_pri_greetpb_greet_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_greet_s6_pri_greetpb_greet_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_greet_s6_pri_greetpb_greet_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_greet_s6_pri_greetpb_greet_proto_goTypes,
		DependencyIndexes: file_greet_s6_pri_greetpb_greet_proto_depIdxs,
		MessageInfos:      file_greet_s6_pri_greetpb_greet_proto_msgTypes,
	}.Build()
	File_greet_s6_pri_greetpb_greet_proto = out.File
	file_greet_s6_pri_greetpb_greet_proto_rawDesc = nil
	file_greet_s6_pri_greetpb_greet_proto_goTypes = nil
	file_greet_s6_pri_greetpb_greet_proto_depIdxs = nil
}
...
func (c *calculatorServiceClient) PrimeManyTimes(ctx context.Context, in *PrimeNumberRequest, opts ...grpc.CallOption) (CalculatorService_PrimeManyTimesClient, error) {
	stream, err := c.cc.NewStream(ctx, &_CalculatorService_serviceDesc.Streams[0], "/greet_s6_pri.CalculatorService/PrimeManyTimes", opts...)
	if err != nil {
		return nil, err
	}
...
var _CalculatorService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "greet_s6_pri.CalculatorService",
	...
	Metadata: "greet_s6_pri/greetpb/greet.proto",
}
